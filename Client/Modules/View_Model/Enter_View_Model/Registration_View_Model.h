...
public:
    explicit Registration_View_Model(Register_View_Ptr register_view, Register_Message_Ptr register_data):
    m_register_view(std::move(register_view)),m_register_data(std::move(register_data)){}
