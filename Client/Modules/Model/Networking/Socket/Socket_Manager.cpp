...
Socket_Manager::Socket_Manager(socket_shared_ptr socket, io_context io_context):
m_socket_to_manage(std::move(socket)),m_io_context_to_manage(std::move(io_context)) {
}
